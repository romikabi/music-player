...
public struct TrackSearch<Collection: RandomAccessCollection & Equatable & ExpressibleByArrayLiteral>: ReducerProtocol where Collection.Element: Track {
  ...
  public func reduce(into state: inout State, action: Action) -> EffectTask<Action> {
    ...
    case let .queryChanged(newQuery):
      ...
      return .task {
        .searchCompleted(await searchTracks(newQuery, urlSession, jsonDecoder))
      }.debounce(
